...
void capnhatTTSV(SV &sv) {
    ...
    while(true) {
        ...
        switch(chon) {
            case 1:
                std::cout<< "\n----------\n";
                std::cout<< "Ten sinh vien chua chinh sua: " << sv.ten;
                std::cout<< "\nNhap lai ten muon chinh sua: ";
            ...
            case 2:
                std::cout<< "\n----------\n";
                std::cout<< "Gioi tinh cua sinh vien chua chinh sua: " << sv.gt << endl;
                laygioitinh(sv);
                std::cout<< "Cap nhat TTSV thanh cong!!!";
                getchar();
                return;
